...
```text
bin/Debug/net7.0/win-x64/publish/PkCompletionist.exe
```

- Use this exe path for command-line testing after compiling. Example:

```powershell
& "./bin/Debug/net7.0/win-x64/publish/PkCompletionist.exe" validate "C:\Users\Samuel\Game\DS\ROM\Pokemon Black2.sav"
```
